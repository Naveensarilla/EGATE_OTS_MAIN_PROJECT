...
import "../../../../Frontend/Pages/Paper/Paper.css";
// import ButtonsFunctionality from "./ButtonsFunctionality";
// import TestResultsPage from "./TestResultsPage";
import PaperHeader from "../../../../Frontend/Components/PaperHeader/PaperHeader";
import TestResultsPage from "../../../../Frontend/Pages/MainQuizFunctionality/TestResultsPage";
import ButtonsFunctionality from "../../../../Frontend/Pages/MainQuizFunctionality/ButtonsFunctionality";

const DemPracticeQuestions = ({ answeredQuestions }) => {
  ...
  useEffect(() => {
    ...
    const fetchQuestionData = async () => {
      try {
        const response = await fetch(
          `http://localhost:3081/getPaperData/1`
        );
        const data = await response.json();
    ...
    <div className="Main-Page ">
      {showResult ? (
        ...
        <div>
          ...
          <div className="QUESTIONS_CONTAINER" style={{display:'grid',gridTemplateColumns:'80% 25%'}}>
...
export default DemPracticeQuestions;
