...
const HomeLandingPage = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3081/courses")
      .then((res) => {
        setCourses(res.data);
...
export const Header = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3081/examsug")
      .then((res) => {
        setExamsug(res.data);
        console.log(res.data);
      })
...
export const Quiz_Courses = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3081/coursesug")
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3081/coursespg")
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3081/coursesmba")
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3081/coursesca")
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3081/examspg")
      .then((res) => {
        setExamspg(res.data);
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3081/examsmba")
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3081/examsca")
      .then((res) => {
        setExamsca(res.data);
  ...
  // useEffect(() => {
  //   axios
  //     .get(`http://localhost:3081/feachingcourse/${examId}`)
  //     .then((response) => {
...
//     useEffect(() => {
//         axios.get('http://localhost:3081/examsdefult')
//           .then((res) => {
...
//       axios.get(`http://localhost:3081/exams/` + e.target.value)
//         .then((res) => {
//           setExams(res.data);
//           console.log(res)
//         })
